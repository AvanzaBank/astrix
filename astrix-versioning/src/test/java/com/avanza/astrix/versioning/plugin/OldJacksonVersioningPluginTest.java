...
public class OldJacksonVersioningPluginTest {
	
	@Test
	public void serializesV2Objects() throws Exception {
		AstrixObjectSerializer astrixObjectSerializer = new JacksonVersioningPlugin().create(AstrixApiDescriptor.create(FakeDescriptor.class));
	...
	@AstrixVersioned(
		version = 2,
		apiMigrations = {
			TestPojoV1ToV2Migration.class
		},
		objectMapperConfigurer = TestObjectMapperConfigurer.class
	)
	public static class FakeDescriptor {
	}
	
	public static class TestObjectMapperConfigurer implements AstrixObjectMapperConfigurer {
		@Override
