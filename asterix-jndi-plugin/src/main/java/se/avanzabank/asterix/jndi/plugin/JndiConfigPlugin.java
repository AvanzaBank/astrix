...
import se.avanzabank.asterix.context.AsterixExternalConfigPlugin;
import se.avanzabank.asterix.provider.core.AsterixPluginQualifier;

@MetaInfServices(AsterixExternalConfigPlugin.class)
@AsterixPluginQualifier("jndi")
public class JndiConfigPlugin implements AsterixExternalConfigPlugin {
