...
public class GsBinderTest {
	...
	public void parsesASpaceUrl() throws Exception {
		...
		ServiceProviderInstanceProperties serviceProperties = gsBinder.createServiceProperties("jini://*/*/service-registry-space?locators=testgssystem01.test.aza.se,testgssystem02.test.aza.se");
