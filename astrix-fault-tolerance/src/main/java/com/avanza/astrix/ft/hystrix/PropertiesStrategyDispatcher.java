...
final class PropertiesStrategyDispatcher extends HystrixPropertiesStrategy {
	
	private final HystrixStrategyMapping strategyMapping;
	
	public PropertiesStrategyDispatcher(HystrixStrategyMapping strategyMapping) {
