...
final class BeanFaultToleranceImpl implements BeanFaultTolerance {
	...
	BeanFaultToleranceImpl(PublishedAstrixBean<?> serviceDefinition, BeanConfiguration beanConfiguration, DynamicConfig config, HystrixCommandNamingStrategy commandNamingStrategy) {
