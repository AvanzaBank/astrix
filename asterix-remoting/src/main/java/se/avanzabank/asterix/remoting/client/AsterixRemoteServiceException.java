 ...
 *
 */
public class AsterixRemoteServiceException extends RuntimeException {
	...
	public AsterixRemoteServiceException(String serviceExceptionMessage, String serviceExceptionType, String correlationId) {
